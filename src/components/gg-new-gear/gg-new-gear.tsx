                ...
                <ion-content>
                    <ion-list>
                        ...
                        <ion-item>
                            ...
                            <ion-select
                                onIonChange={(e) => this.gearTypeChange(e)}
                                value={this.gear.type}
                                okText="Okay"
                                cancelText="Dismiss">
                        ...
                        <ion-item>
                            ...
                            <ion-toggle
                                onIonChange={(e) => this.gearApprovalNeeded(e)}
                                checked={this.gear.approvalNeeded}></ion-toggle>
                        </ion-item>
                        <ion-item>
                            <ion-button>Tap NFC Chip</ion-button>
